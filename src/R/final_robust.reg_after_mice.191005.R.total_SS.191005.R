...
sink("sink.list.res.lmrob.Ro60.mice.data_SS.")
...
df.coef.pooled.res.lmrob.Ro60.mice.data_SS <-
 ...
 save.image("test_lmrob.190822.RData")
 load("lmrob.190822.RData")
...
write.csv(
  df.coef.pooled.res.lmrob.Ro60.mice.data_SS[
    -grep(".int", df.coef.pooled.res.lmrob.Ro60.mice.data_SS$.id),
    ], 
  sprintf(
    "%s/%s",
    dir.output, "test_final_df.coef.pooled.res.lmrob_MM_init.S_Ro60.mice.data_SS.csv"
    )
  )
